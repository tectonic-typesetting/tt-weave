...
\XeTeX\ is a modified version of Donald E.\ Knuth’s \TeX\ program that adds
support for Unicode text and OpenType fonts, among other changes. It is the
foundation of the \href{https://tectonic-typesetting.github.io/}{Tectonic
project}, a modernized \TeX\ typesetting system, which is built around a
modified clone of the \XeTeX\ engine.
...
— viewed holistically as both code and documentation — is the exclusive work of
...
The full \XeTeX\ program consists of not only WEB code, but also extensions
written in C and C++. Those extensions are not included in this book.
Furthermore, \XeTeX\ itself must be combined with other programs and data files
to do anything useful with a modern \TeX\ document. Those ecosystem-level
aspects are not addressed here either.
...
A program called
\href{https://github.com/tectonic-typesetting/tt-weave/}{tt-weave} processes the
WEB file into \TeX\ code that is then compiled into HTML using
\href{https://tectonic-typesetting.github.io/}{Tectonic}. The tt-weave program
emits the code component of the WEB language after reformatting it into a new
syntax resembling the C and Rust languages. Between this rewriting and the fact
that the original typesetting targets the printed page, not the screen, this
digital book should be taken as informative \textit{but not definitive}
regarding the workings of \XeTeX.
